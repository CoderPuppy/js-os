		...
		function CMDContext(runContext, cmd, options) {
			...
			for(pipeName in this.filePipes) {
				if(pipeName != '1' && pipeName != '2') {
					...
					if(this.filePipes[pipeName].dir[0] == '>') fileStream.unpause();
			...
			if(this.filePipes['1']) {
				...
				if(this.filePipes['1'].dir[0] == '>') fileStream.unpause();
			...
			if(this.filePipes['2']) {
				...
				if(this.filePipes['2'].dir[0] == '>') fileStream.unpause();
			
				( this.filePipes['2'].dir[0] == '>' ? this.data : fileStream ).pipe(( this.filePipes['2'].dir[0] == '<' ? this.data : fileStream ));
			}
		}
